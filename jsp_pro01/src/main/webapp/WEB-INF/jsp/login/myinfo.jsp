...
window.onload =function() {
	  previewImg.addEventListener("click", function(e) {//미리 보여주기
		 imgSelect.click(); 
	  });
...
function ajaxImageUpload(e){
	...
	$.ajax({
		...
		data: fData,
		processData: false, //ajax로 파일업로드하기 위해서는 processData, contentType이 필수로 들어가야함.
		contentType: false,
...
<body>
	...
	<section class="container">
		...
		<form class="large-form" action="${myInfoUpdateUrl}" method="post" enctype="multipart/form-data"><!-- 이미지/파일 업로드할때 꼭 쓰기!-->
			<div class=" image-form left">
				<img id="previewImg" class="image-360" alt="여기에는 증명 사진이 배치됩니다." src="${imagePath}">
			    <br>
			    <input id="imgSelect" type="file" name="uploadImg" vlaue="이미지 선택" accept="image/png">
