...
<c:url var="staticUrl" value="/static" /><!-- context path를 쓸필요없이 자동으로 들어가는 것 -->
<link rel="stylesheet" type="text/css" href="${staticUrl}/css/default.css">
<link rel="stylesheet" type="text/css" href="${staticUrl}/css/form.css">
<link rel="stylesheet" type="text/css" href="${staticUrl}/css/navigation.css">
