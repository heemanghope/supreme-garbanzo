...
<body>
	...
	<section class="container">
		...
		<table class="table wide vertical-hidden hover"><%--세로줄 제거 vertical-hidden --%>
			<colgroup><%--간격을 조정함 --%>
				<col class="col-120">
				<col class="col-auto">
				<col class="col-120">
			...
			<div class="paging">
				<ul class="page center">
					<c:if test="${currentPage - 1 > 0}">
						<li class="page-item">
							<a class="page-link" href="./depts?page=${currentPage - 1}">Prev</a><%--1-4까지하기위해서 -1을 해준다. --%>
						</li>
					</c:if>
