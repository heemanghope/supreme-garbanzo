...
res6.innerHTML +="arr1.push(10) -> 배열 크기:" + arr1.push(10) + "<br>";
res6.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";
res6.innerHTML +="<br>";
res6.innerHTML +="arr1.push(20,30) -> 배열 크기:" + arr1.push(20,30) + "<br>";
res6.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";
...
res7.innerHTML +="<br>";
res7.innerHTML +="arr1.unshift(6,7) -> 배열 크기:" + arr1.unshift(6,7) + "<br>";
res7.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";
res7.innerHTML +="<br>";


res8= document.getElementById("res8");
res8.innerHTML +="arr1.pop() -> 삭제된 값:" +arr1.pop() +"<br>";//맨뒤 X
res8.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";
res8.innerHTML +="<br>";

res9 = document.getElementById("res9");
res9.innerHTML +="arr1.shift() -> 삭제된값:" +arr1.shift() +"<br>";//맨 앞 X
res9.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";
res9.innerHTML +="<br>";


res10 =document.getElementById("res10");
res10.innerHTML +="arr1.slice(2) -> 잘려진 배열의 값:" +arr1.slice(2) +"<br>";
res10.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";
res10.innerHTML +="<br>";
res10.innerHTML +="arr1.slice(2,6) -> 잘려진 배열의 값:" +arr1.slice(2,6) +"<br>";
res10.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";
res10.innerHTML +="<br>";
...
res12.innerHTML +="arr1.sort(function(x,y) {return x-y}) -> "
       +arr1.sort(function(x,y) {return x-y}) +"<br>";   //오름차순
res12.innerHTML +="실행 후 출력 결과 : " + arr1+"<br>";         
res12.innerHTML +="<br>";      
res12.innerHTML +="arr1.sort(function(x,y){return y-x}) -> "
       +arr1.sort(function(x,y) {return y-x}) +"<br>";   //내림차순
res12.innerHTML +="실행 후 출력 결과 : " +arr1+"<br>";            
res12.innerHTML +="<br>";
 ...
 */
 ...
 for(let i=0; i<arr3.length; i++) {
	arr3[i] = arr3[i].trim(); //불필요한 공백 삭제 trim
}
