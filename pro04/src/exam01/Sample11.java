...
public class Sample11 {
	...
	public static void main(String[] args) {
		/*
		 * 사용자 입력을 받아서 다음의 기능을 수행하는 코드를 작성 x
		 *   
		...
		int i =0;
		for(;;) {
			System.out.printf("%d 번째 정수값 입력 : ", i + 1); //반복횟수를 가지고 알아냈는데 i값으로 알수 없으므로,
     ...
     //사용자입력을받음
				...
				//sc.nextLine(); 를 쓰는 이유!
				//버퍼의 남아있는 데이터를 클리어시켜준다. 버퍼//개행이 남아있다. 
                //클리어 플러쉬 ->> 스캐너로,, (엔터키)(=개행)을 날려버리기위해서 (2)번 겹쳐져있으면 넥스트 라인을 쓴다.
