...
public class Sample01 {
	...
	public static void main(String[] args) {
		 ...
		 *   -프로그램 코드의 실행을 제어하기 위해 사용하는 문법
 		 ...
 		 *     0~ 무한 반복 까지 일정 횟수 반복을 위해 많이 사용을 한다.
		 ...
		 *        생략 가능하다. 단, 조건식을 생략하면 기본적으로 반복을 진행하는 것으로 동작하기 때문에 무한반복에 빠질 수 있다.
		 *        반복문 내부의 별도의 if 조건문과 break 를 작성하여 종료 조건을 반드시 생성해야 한다.
		 *        조건식의 설정도 잘못 설정하는 경우 무한반복에 빠질 수 있기 때문에 조건을 반드시 확인해야 한다.   
		 * 증감식 : 값의 증감을 통해 반복문의 조건식의 조건을 맞추어 주기 위해 사용한다.
		 *         생략 가능하다. 단,생략을 하면 종료 조건에 맞는 값을 설정할 수 없어지기 때문에 무한반복이 될 수 있다.
		 *         중감식은 주로 ++, -- 증감연산을 사용하거나 복합할당연산을 사용한다.
		 *         
		 */
